<template>
  <svg width="1569" height="346" viewBox="0 0 1569 346" fill="none" class="h-auto w-full tablet:col-start-1 tablet:col-end-3">
    <path
      ...
      class="default-transition text-trustBlue dark:text-trustGreen"
